...
class ArtistDBHelper:
    ...
    def get_all_artists(self, filter_name: str | None = None) -> Sequence[db.Artist]:
        ...
        if filter_name:
            query = query.where(func.lower(db.Artist.name).like(f"%{filter_name.lower()}%"))
...
class AlbumDBHelper:
    ...
    def get_all_albums(self, filter_name: str | None = None) -> Sequence[db.Album]:
        ...
        if filter_name:
            query = query.where(func.lower(db.Album.name).like(f"%{filter_name.lower()}%"))
        return self.session.exec(query).all()
...
class TrackDBHelper:
    ...
    def get_all_tracks(self, filter_title: str | None = None) -> Sequence[db.Track]:
        ...
        if filter_title:
            query = query.where(func.lower(db.Track.title).like(f"%{filter_title.lower()}%"))
        return self.session.exec(query).all()
